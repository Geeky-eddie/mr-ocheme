...
const createInitialNodes = (updateNodeData: (id: string, newData: Record<string, unknown>) => void): Node[] => [
  // Identification Phase
  {
    ...
    data: {
      ...
      gradient: `linear-gradient(to bottom, ${colors.slate600}, ${colors.slate700})`,
      textColor: "white",
      updateNodeData,
    },
    draggable: true,
  ...
  // Eligibility Phase
  {
    ...
    position: { x: 50, y: 550 },
    data: {
      label: "Eligibility Phase",
      gradient: `linear-gradient(to bottom, ${colors.purple200}, ${colors.purple300})`,
      textColor: colors.slate800,
      updateNodeData,
    },
    draggable: true,
  ...
  // Included Phase
  {
    ...
    data: {
      label: "Included",
      gradient: `linear-gradient(to bottom, ${colors.purple100}, ${colors.purple200})`,
      textColor: colors.slate800,
      updateNodeData,
    },
    draggable: true,
